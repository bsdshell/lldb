# /Users/cat/myfile/github/lldb/logging.py

import lldb
import re

def __lldb_init_module (debugger, dict):
  debugger.HandleCommand('command script add -f logging.getAll getAll')
  debugger.HandleCommand('command script add -f logging.logv logv')
